...
#error "Please define a way to initialize a memory block."
    ...
    float coremark_dmips = ((uint64_t)results[0].iterations*1000000)/((float)total_time/1.3);
    ...
    printf("**********************************************\n");
       printf("** begin to test using nice decrypt and encryptss\n");
