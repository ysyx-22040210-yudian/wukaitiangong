...
#
# Generated by export_simulation on Sat May 27 10:59:01 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_0.sh' script.

./c_shift_ram_0.sh -reset_run
...
./c_shift_ram_0.sh -noclean_files

For more information on the script, please type './c_shift_ram_0.sh -help'.
