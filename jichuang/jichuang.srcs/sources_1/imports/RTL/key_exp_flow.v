...
assign	result_out			=	count_round_in == 'd0	?
								...
								{word_1, word_2, word_3, data_after_transform_key ^ word_0};//keyii, keyii+1, keyii+2, keyii+3

key_exp_T	u_transform_key
	(
		.data_in(data_for_transform),
		.data_after_linear_key_out(data_after_transform_key) //L′(B)=B⊕(B<<13)⊕(B<<23)
