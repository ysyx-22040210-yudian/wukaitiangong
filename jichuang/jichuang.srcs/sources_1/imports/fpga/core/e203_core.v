...
module e203_core(
  ...
  wire  [`BHR_WIDTH-1:0]  bjp_o_cmt_bhr    ;
  wire  [1:0] bpu_fixpht_w     ;
  wire  [`E203_PC_SIZE-1:0] bjp_o_cmt_takenpc;
  wire bjp_o_cmt_taken  ;
  wire bpu_exisjump     ;
  wire [`E203_PC_SIZE-1:0] bpu_fixpc        ;
  wire [`E203_PC_SIZE-1:0] bpu_fixjumpaddr  ;
  wire [2:0]  ex_bjop_o        ;
  wire bpu_fixwe_w      ;
  wire btb_fixwe_w      ;
  wire [`BHR_WIDTH-1:0]        BHR_o_r;
  wire [1:0]                   PHT_o_r;
  wire [`E203_PC_SIZE-1:0]     bpu_taken_pc;
  wire                         bpu_taken;
  //*********************new iotf start*************************//
  wire [`E203_OITF_DEPTH-1:0]  vld_r                     ;
  wire [`E203_OITF_DEPTH-1:0]  rdwen_r               ;
  wire [`E203_RFIDX_WIDTH-1:0] rdidx_r0               ;
  wire [`E203_RFIDX_WIDTH-1:0] rdidx_r1               ;
  wire [`E203_RFIDX_WIDTH-1:0] rdidx_r2               ;
  wire [`E203_RFIDX_WIDTH-1:0] rdidx_r3               ;
//********************new end********************************//
 wire [`E203_PC_SIZE-1:0] alu_cmt_pc;
  ...
  `endif//}
    ...
    .BHR_o_r                (BHR_o_r             ),
    .PHT_o_r                (PHT_o_r             ),
    .bpu_taken_pc           (bpu_taken_pc        ),
    .bpu_taken              (bpu_taken           ),
    //******************new end******************//
    //*******************************new start*****************************
      .bpu_exfixbhr         (bjp_o_cmt_bhr    ),
      .bpu_exfixpht         (bpu_fixpht_w   ),
      .bpu_fixpc            (bpu_fixpc        ),
      .bpu_fixjumpaddr      (bpu_fixjumpaddr   ),
      //.bjp_o_cmt_taken      (bjp_o_cmt_taken  ),
      .bpu_exisjump         (bpu_exisjump      ),
      .ex_bjop              (ex_bjop_o        ),
      .bpu_fixwe_w          (bpu_fixwe_w    ),
      .btb_fixwe_w          (btb_fixwe_w    ),
...
//********************new end********************************//
  ...
  `endif//}
    ...
    .i_BHR                  (BHR_o_r             ),
    .i_PHT                  (PHT_o_r             ),
    .i_bpu_taken_pc         (bpu_taken_pc        ),
    .i_bpu_taken            (bpu_taken           ),
    //******************new end******************//
    //*******************************new start*****************************
      .bjp_o_cmt_bhr        (bjp_o_cmt_bhr    ),
      .bpu_fixpht_w         (bpu_fixpht_w     ),
      .bpu_fixpc            (bpu_fixpc     ),
      .bpu_fixjumpaddr      (bpu_fixjumpaddr     ),
      .bjp_o_cmt_taken      (bjp_o_cmt_taken    ), //delete
      .cmt_taken           (bpu_exisjump    ),
      .ex_bjop_o            (ex_bjop_o    ),
      .bpu_fixwe_w          (bpu_fixwe_w    ),
      .btb_fixwe_w          (btb_fixwe_w    ),
      .alu_cmt_pc         (alu_cmt_pc),
