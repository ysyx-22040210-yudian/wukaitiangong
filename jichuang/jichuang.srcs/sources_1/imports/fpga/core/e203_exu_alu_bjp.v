...
module e203_exu_alu_bjp(
  ...
  output [1:0]                bjp_o_cmt_pht     ,// The predicted ture/false
  output [`E203_PC_SIZE-1:0]  bjp_o_cmt_takenpc ,// The predicted ture/false
  ...
  //********************************new start**********************************
  assign bjp_o_cmt_bhr     = bjp_i_info[`E203_DECINFO_BJP_BHR]    ;
  assign bjp_o_cmt_pht     = bjp_i_info[`E203_DECINFO_BJP_PHT]    ;
  assign bjp_o_cmt_takenpc = bjp_i_info[`E203_DECINFO_BJP_TAKENPC];
  assign bjp_o_cmt_taken   = bjp_i_info[`E203_DECINFO_BJP_TAKEN]  ;
//********************************new end**********************************************
  assign bjp_o_cmt_rslv  = jump ? 1'b1 : bjp_req_alu_cmp_res;  //as ex_isjump_o
