...
module e203_exu_alu_muldiv(
  ...
  //wire divu_inst = i_divu | i_remu;
  //wire div_inst = i_div | i_rem;

//*****************************************mul *******************************************//
  wire     [31:0]   mulI_payload_a    ;
  wire     [31:0]   mulI_payload_b    ;
  wire              mulI_payload_high ;
  wire              mulI_payload_sign ;
  wire     [31:0]   mulO_payload      ;


  assign mulI_payload_a    = muldiv_i_rs1;
  assign mulI_payload_b    = muldiv_i_rs2;
  assign mulI_payload_high = i_mulh | i_mulhsu | i_mulhu;
  assign mulI_payload_sign = 1'b1;
//***************************************/************************************************
  //wire div_inst = i_div | i_divu;
  //wire rem_inst = i_rem    | i_remu0
  ...
  assign s_axis_dividend_tvalid = (i_div | i_rem)  & muldiv_i_valid;
  assign s_axis_divisor_tvalid = s_axis_dividend_tvalid;
  assign s_axis_dividend_tdata = muldiv_i_rs1;
  assign s_axis_divisor_tdata  = muldiv_i_rs2;
  assign div_res_r = m_axis_dout_tdata[63:32];
  assign rems_r =  m_axis_dout_tdata[31:0];
//****************************************div**************************************************

  wire s_axis_divuisor_tvalid;
	wire s_axis_divuidend_tvalid;
	wire [31:0] s_axis_divuisor_tdata;
	wire [31:0] s_axis_divuidend_tdata;
	wire m_axis_udout_tvalid;
	wire [63:0] m_axis_udout_tdata;
  wire [31:0] divu_res_r;
  wire [31:0] remsu_r;

  assign s_axis_divuidend_tvalid = (i_divu | i_remu)  & muldiv_i_valid;
  assign s_axis_divuisor_tvalid = s_axis_divuidend_tvalid;
  assign s_axis_divuidend_tdata = muldiv_i_rs1;
  assign s_axis_divuisor_tdata  = muldiv_i_rs2;
  assign divu_res_r = m_axis_udout_tdata[63:32];
  assign remsu_r =  m_axis_udout_tdata[31:0];
//****************************************divu**************************************************
...
//********************************************************************************************
 ...
 //***********************************new start***************************************
assign exec_last_cycle = i_op_div & div_exec_last_cycle;
//***********************************new end***************************************
...
// Output generateion
  ...
  /*wire wbck_condi = (back2back_seq | special_cases) ? 1'b1 : 
    ...
    wire wbck_condi = 
                          (1'b1 & i_op_mul)
    //***************************new end*****************************************
                         | (m_axis_dout_tvalid & (i_div | i_rem))
                         | (m_axis_udout_tvalid & (i_divu | i_remu)) 
  ...
  assign muldiv_o_wbck_wdat = 
               ({`E203_XLEN{i_rem}} & rems_r)
             | ({`E203_XLEN{i_div}} & div_res_r)
             | ({`E203_XLEN{i_remu}} & remsu_r)
             | ({`E203_XLEN{i_divu}} & divu_res_r)
  //*************************************new start*************************************
             | ({`E203_XLEN{i_op_mul}} & mulO_payload);
  //*****************************************new start*****************************************
...
//******************************new start*********************************
  assign muldiv_sbf_0_ena = 1'b0;//part_remd_ena;
  assign muldiv_sbf_0_nxt = part_remd_nxt;
  assign muldiv_sbf_1_ena = 1'b0;//part_quot_ena;
  assign muldiv_sbf_1_nxt = part_quot_nxt;
//***********************************************************************
...
mul mul_dut
(
    .mulI_payload_a   (mulI_payload_a   ),
    .mulI_payload_b   (mulI_payload_b   ),
    .mulI_payload_high(mulI_payload_high),
    .mulI_payload_sign(mulI_payload_sign),

    .mulO_payload     (mulO_payload     )
);
...
div_gen_0 divu_dut (
  .aclk(clk),                                      // input wire aclk
  .s_axis_divisor_tvalid(s_axis_divuisor_tvalid),    // input wire s_axis_divisor_tvalid
  .s_axis_divisor_tdata(s_axis_divuisor_tdata),      // input wire [31 : 0] s_axis_divisor_tdata
  .s_axis_dividend_tvalid(s_axis_divuidend_tvalid),  // input wire s_axis_dividend_tvalid
  .s_axis_dividend_tdata(s_axis_divuidend_tdata),    // input wire [31 : 0] s_axis_dividend_tdata
  .m_axis_dout_tvalid(m_axis_udout_tvalid),          // output wire m_axis_dout_tvalid
  .m_axis_dout_tdata(m_axis_udout_tdata)            // output wire [63 : 0] m_axis_dout_tdata
);
