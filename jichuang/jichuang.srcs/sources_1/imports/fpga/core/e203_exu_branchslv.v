...
module e203_exu_branchslv(
  ...
  //********************************new start******************************** *********************
 wire [`E203_PC_SIZE-1:0] jalr_addr = i_rs1 + cmt_i_imm;
 wire jalr_flush = jalr_addr != i_bpu_taken_pc;
  //********************************new end******************************** *********************
  ...
  wire brchmis_need_flush = (
        ((cmt_i_bjp & !dec_jalr)  & (cmt_i_bjp_prdt ^ cmt_i_bjp_rslv))     ///As to jalr,need to think the ADDR is right or worng
  //********************************new start******************************** *********************
       | ((cmt_i_bjp &  dec_jalr)  & (jalr_flush))  
  //********************************new end******************************** *********************
  ...
  assign brchmis_flush_pc = 
                          ...
                          //(cmt_i_fencei | ((cmt_i_bjp & !dec_jalr) & cmt_i_bjp_prdt)) ? (cmt_i_pc + (cmt_i_rv32 ? `E203_PC_SIZE'd4 : `E203_PC_SIZE'd2)) :
                          (cmt_i_fencei | (cmt_i_bjp & !cmt_i_bjp_rslv & cmt_i_bjp_prdt)) ? (cmt_i_pc + (cmt_i_rv32 ? `E203_PC_SIZE'd4 : `E203_PC_SIZE'd2)) :
                          ((cmt_i_bjp & !dec_jalr) & (~cmt_i_bjp_prdt))  ? (cmt_i_pc + cmt_i_imm[`E203_PC_SIZE-1:0]) :
                          //*********************new start******************************************//
                          ((cmt_i_bjp & dec_jalr) & jalr_flush) ? jalr_addr :
                          //***********************************new end********************************//
