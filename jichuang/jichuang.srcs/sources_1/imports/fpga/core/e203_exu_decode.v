...
module e203_exu_decode(
  ...
  wire rv32_op_imm   = opcode_6_5_00 & opcode_4_2_100 & opcode_1_0_11; //I inst
  ...
  //********************************new start**********************************
  assign bjp_info_bus[`E203_DECINFO_BJP_BHR]     = i_BHR;
  assign bjp_info_bus[`E203_DECINFO_BJP_PHT]     = i_PHT;
  assign bjp_info_bus[`E203_DECINFO_BJP_TAKENPC] = i_bpu_taken_pc;
  assign bjp_info_bus[`E203_DECINFO_BJP_TAKEN]   = i_bpu_taken;


  wire rs1is1or5     = (rv32_instr[19:15] == 5'b00001) | (rv32_instr[19:15] == 5'b00101);
  wire rdis1or5      = (rv32_instr[11:7]  == 5'b00001) | (rv32_instr[11:7]  == 5'b00101);
  wire isjalrpush    = rs1is1or5 && rdis1or5 && (rv32_rs1 == rv32_rd) || (!rs1is1or5 &&rdis1or5);
  wire isjalrpushpop = rs1is1or5 && rdis1or5 && (rv32_rs1 != rv32_rd);

  assign ex_bjop_o = ({3{dec_jal}} & (rdis1or5 ? `ysyx_22050058_BTB_CALLOP : `ysyx_22050058_BTB_JALOP)) |
                     ({3{dec_jalr}} & ((!rdis1or5 && rs1is1or5) ? `ysyx_22050058_BTB_RETOP : 
                                      (isjalrpush ? `ysyx_22050058_BTB_CALLOP : 
                                      (isjalrpushpop ? `ysyx_22050058_BTB_CALLANDRETOP : `ysyx_22050058_BTB_JALOP)))) |
                     ({3{rv32_ecall}} & `ysyx_22050058_BTB_CSROP) |
                     ({3{rv32_mret}}  & `ysyx_22050058_BTB_CSROP) ;
//********************************new end**********************************************
...
assign exisjump = dec_bjp | rv32_ecall | rv32_mret;
