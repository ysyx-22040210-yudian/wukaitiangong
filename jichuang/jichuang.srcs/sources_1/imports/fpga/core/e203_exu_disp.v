...
module e203_exu_disp(
  ...
  assign disp_o_alu_valid = disp_i_valid_pos;  //可以派遣指令到alu
  ...
  assign disp_i_valid_pos = disp_condition & disp_i_valid;   //decode完成握手，使得指令可以进入EXU
  assign disp_i_ready     = disp_condition & disp_i_ready_pos;  //exuLalu完成握手，使得指令可以进入EXU
  ...
  assign disp_o_alu_info  = disp_i_info;  
    ...
    // 在派 点产生 OITF 分配表项的使能信号
    // 如果当前派 的指 为一个长指令则产生此使能信号
