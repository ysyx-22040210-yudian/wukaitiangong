...
sirv_gnrl_icb2axi # (
  ...
  .DW   (`E203_XLEN) 
    ...
    assign  expl_axi_arready = 1'b1;
  assign  expl_axi_awready = 1'b1;
  assign expl_axi_rvalid  = 1'b1;
  assign expl_axi_rdata  = 32'd123;
  assign expl_axi_rresp  = 2'b0;
  assign expl_axi_rlast   = 1'b1;
  assign expl_axi_wready = 1'b0;
  assign expl_axi_bvalid = 1'b1;
  assign expl_axi_bresp = 2'b0;
/*
sirv_expl_axi_slv # (
  .AW   (32),
  .DW   (`E203_XLEN) 
